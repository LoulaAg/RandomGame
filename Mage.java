...
public class Mage extends Character{
	...
	public static void intro(Scanner scan){
		...
		scan.nextLine();
		System.out.println("Even from atop Wegman-Carter Tower, you can hear the distant sounds of war.");
		scan.nextLine();
		...
		scan.nextLine();
		System.out.println("The Grandmaster sighs and closes his eyes. You don't know what this means for you, but as the dragon's cry echoes throughout the tower, you are ready.");
		scan.nextLine();
		System.out.println("You call fire, water, earth, and wind to your side and prepare to unleash it all.");
	}
}
